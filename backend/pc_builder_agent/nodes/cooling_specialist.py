    ...
    *,
    ...
    ai_message, text = run_agent_turn(
        ...
        system_prompt=(
            ...
            "- Do not answer from pc_board_response, request text, or memory alone; pc_board_response is only for identifying the cooler/fan model to search.\n"
            "- Even if pc_board_response already lists specs, still search to verify thermal capacity, noise, clearance, and value from trusted reviews.\n"
